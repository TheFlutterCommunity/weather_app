...
class _WeatherAPIService implements WeatherAPIService {
  ...
  Future<WeatherDetails> getDashboardDetails({
    ...
    final queryParameters = <String, dynamic>{r'key': apiKey, r'q': latLng};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<WeatherDetails>(
    ...
    late WeatherDetails _value;
    try {
      _value = WeatherDetails.fromJson(_result.data!);
    } on Object catch (e, s) {
